          ...
          <tr>
            <td style="padding:36px 32px 28px;">
              ...
              <p style="margin:0 0 28px;font-size:14px;color:#64748B;line-height:22px;">
                Welcome to CommuTech! Use the code below to verify your email address and complete your registration. This code expires in <strong>10 minutes</strong>.
              </p>
              ...
              <p style="margin:0 0 8px;font-size:13px;color:#64748B;line-height:20px;">
                Enter this code in the CommuTech app to activate your account. Do not share it with anyone.
              </p>
              <p style="margin:0;font-size:13px;color:#64748B;line-height:20px;">
                If you did not create a CommuTech account, you can safely ignore this email.
              </p>
            </td>
          </tr>
